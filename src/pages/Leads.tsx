          ...
          <div style={{ display:'flex', gap:'6px', alignItems:'center' }}>
            {isMobile ? (
              ...
              <>
                ...
                {/* Período desktop — botão abre modal centralizado */}
                <button onClick={()=>setShowCustom(true)} style={{display:'flex',alignItems:'center',gap:'5px',padding:'7px 10px',borderRadius:'9px',border:`1px solid ${border}`,background:dark?'#111113':'#ffffff',color:dark?'#d4d4d8':'#374151',fontSize:'12.5px',cursor:'pointer',fontFamily:'inherit',whiteSpace:'nowrap'}}>
                  {periodLabel}<ChevronDown style={{width:'13px',height:'13px'}}/>
                </button>
                {/* Mas mantém o dropdown rápido para os períodos predefinidos */}
